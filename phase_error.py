...
c_range = np.linspace(0, 60, 100)
r_range = np.linspace(0, 60, 100)
...
phase_error_x, n_shift_x = calculate_phase_error(sumo_x, interpolated_carla_x, best_c_h, best_r_h)
phase_error_y, n_shift_y = calculate_phase_error(sumo_y, interpolated_carla_y, best_c_h, best_r_h)
